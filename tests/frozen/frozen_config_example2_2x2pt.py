"""AUTO-GENERATED by generate_frozen_reference.py --overwrite (2026-09-21T10:47:35Z).

Frozen, fully expanded cobaya configuration for example2_2x2pt
...
likelihood:
  roman_fourier.combo_2x2pt:
    path: ./projects/roman_fourier/tests/frozen/data
    ...
    print_datavector_file: ./projects/roman_fourier/chains/roman_fourier_theory.modelvector
    type: []
    stop_at_error: false
    version: null
    input_params:

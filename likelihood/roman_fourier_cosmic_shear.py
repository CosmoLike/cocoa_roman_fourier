from cobaya.likelihoods.roman_fourier._cosmolike_prototype_base import _cosmolike_prototype_base, survey
import cosmolike_roman_fourier_interface as ci
import numpy as np

class roman_fourier_cosmic_shear(_cosmolike_prototype_base):
  def initialize(self):
    super(roman_fourier_cosmic_shear,self).initialize(probe="xi")
